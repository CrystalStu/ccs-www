    ...
    <div class="layui-row">
        <div class="layui-col-md12 main">
            ...
            <div class="button">
                ...
                <a class="layui-btn layui-btn-warm  layui-btn-lg layui-btn-radius" style="width: 170px" href="./about.php"><i
        ...
        <div class="layui-col-md3">
            <div class="box">
                <div class="box-body">
                    ...
                    <div class="box-desc">
                        <span>Crystal Studio的NOIP竞赛成员名单</span>
                    </div>
                </div>
                <div class="box-footer">
                    <div class="footer-reference">
        ...
        <div class="layui-col-md3">
            <div class="box">
                <div class="box-body">
                    ...
                    <div class="box-desc">
                        <span>Crystal Studio 基于WPF制作的软件</span>
                    </div>
                </div>
                <div class="box-footer">
                    <div class="footer-reference">
